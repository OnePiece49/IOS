...
class UploadFeedController: UIViewController {
    ...
    var headerPhotoView = UploadHeaderPhotoView(frame: .zero)
    var numberItem = 1
    ...
    func configureUI() {
        ...
        collectionView.register(UploadPhotoCollectionViewCell.self, forCellWithReuseIdentifier: UploadPhotoCollectionViewCell.identifier)
...
//MARK: - delegate
extension UploadFeedController: UICollectionViewDataSource, UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return numberItem
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: UploadPhotoCollectionViewCell.identifier, for: indexPath) as! UploadPhotoCollectionViewCell
